...
alias cleanarch='sudo paccache -rk1 && rm -rf ~/.cache/*'
...
# Di ~/.zshrc atau ~/.bashrc tambahkan:
if [[ "$TERM" == "xterm-kitty" ]]; then
    # Enable Kitty shell integration
    source <(kitty + complete setup zsh)  # Untuk zsh
    # source <(kitty + complete setup bash)  # Untuk bash
fi
export PATH="/opt/lampp/bin:$PATH"
export PATH="$HOME/.local/bin:/opt/lampp/bin:$PATH"

# opencode
export PATH=/home/boba/.opencode/bin:$PATH
